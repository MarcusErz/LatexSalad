...
\section{MIDAS}
\label{sec:midas}
\workTodo{In diesem Kapitel werden grundlegende Themen behandelt, die im Rahmen des Forschungsprojekts zum Verständnis der Ausreißererkennung in Graphen gedient haben.}
...
\section{Ausreißererkennung in Graphen}
\label{sec:m-ex}
\workTodo{ausformulieren \& Text vor dem Bild}
...
Vergleicht man die Ergebnisse aus \autoref{img:midas:enron_anomaly} mit den Ergebnissen aus \workTodo{Anhang SEDANSPOT} so kan man sehen, dass beide Algorithmen einen ähnlichen Verlauf vorweisen. 
...
\workTodo{SEDANSPOT in den Anhang und referenzieren}
...
\section{Ausreißererkennung in Zeitreihen}
