...
\textbf{Man} kann mit den labels im Text bezug nehmen mit \autoref{sec:abc-uk-uuk}. Wenn man zitieren möchte, dann verwendet man am besten  \citep[vgl.][S.~1]{Petkovic}. Ich denke die Logik wird klar, wenn man es hier betrachtet. Anführungszeichen \textit{im Fließtext} erfolgen mittels \dq Wort\dq\space manchmal benötigt man das space um ein Leerzeichen zu generieren.
\subsubsection{Fette Überschrift}
...
Wenn ihr to dos vermerken wollt, nutzt hierfür: 
\workTodo{hier ein to do einfügen}
