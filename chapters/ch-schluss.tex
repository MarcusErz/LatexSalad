...
%Darüber hinaus nimmt der NetSimile zur Erkennung von Ausreißern
% \workTodo{bis hierhin habe ich es ausgeführt}
%Kommen wir nun zum Ausblick:

%Interessant wären weitere Datensätze, auf denen die Algorithmen angewandt werden wie bspw. Finanzdaten oder Bilder. Die einzige Voraussetzung wäre hierbei die Bildung einer Distanz, die zwischen den einzelnen Elementen des Datensatzes gebildet werden müssten.

In einem weiteren Schritt kann die Optimierung des NetSimile Algorithmus erfolgen. Zum einen gibt dieser nur den Ausreißer-Graphen zurück. Zum anderen wird momentan der Graph erst dann berechnet, wenn dieser alle Kanten eines Zeitintervalls beinhaltet. Hierbei könnten Optimierungen folgen, die bswp. den Ausreißer-Graphen auf Knoten oder Kanten untersucht, die für den Ausreißerscore am meisten beigetragen haben. Zudem könnten man einen Weg suchen, um den Graphen iterativ vergrößern zu können, damit eventuell schon vor dem vollständigen Erstellen des Graphens bestimmt werden kann, ob es sich um einen Ausreißer handelt.
