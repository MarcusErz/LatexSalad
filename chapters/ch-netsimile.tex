...
%	$ \hfill\\ Geometrisches Mittel der Kanten mit den 10\% höchsten Kantengewichten. 
	\item $ \sqrt[n]{\prod\limits_{i = 1}^{n} x_i} $ \hfill\\ Geometrisches Mittel der Kanten mit den 10\% höchsten Kantengewichten.
	\item $ \sqrt[n]{\prod\limits_{i = 1}^{n} x_i} $ \hfill\\ Geometrisches Mittel der Kanten mit den 20\% höchsten Kantengewichten. 
\end{itemize}
