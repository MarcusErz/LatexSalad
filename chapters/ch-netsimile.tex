...
\begin{figure}
	\centering
	\includegraphics[height=0.6\linewidth,width=\linewidth]{fig/netsimile/anomalie_10}
	\caption{\workTodo{Platzhalter: Jumpsup}}
	\label{img:netsimile:anomalie_10}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.2\linewidth,width=0.5\linewidth]{fig/netsimile/dauer_10}
	\caption{\workTodo{Platzhalter: Jumpsup}}
	\label{img:netsimile:dauer_10}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.6\linewidth,width=\linewidth]{fig/netsimile/anomalie_11}
	\caption{\workTodo{Platzhalter: Amprise}}
	\label{img:netsimile:anomalie_11}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.2\linewidth,width=0.5\linewidth]{fig/netsimile/dauer_11}
	\caption{\workTodo{Platzhalter: Amprise}}
	\label{img:netsimile:dauer_11}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.6\linewidth,width=\linewidth]{fig/netsimile/anomalie_12}
	\caption{\workTodo{Platzhalter: drift}}
	\label{img:netsimile:anomalie_12}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.2\linewidth,width=0.5\linewidth]{fig/netsimile/dauer_12}
	\caption{\workTodo{Platzhalter: drift}}
	\label{img:netsimile:dauer_12}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.6\linewidth,width=\linewidth]{fig/netsimile/anomalie_13}
	\caption{\workTodo{Platzhalter: jumpsdown}}
	\label{img:netsimile:anomalie_13}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=0.2\linewidth,width=0.5\linewidth]{fig/netsimile/dauer_13}
	\caption{\workTodo{Platzhalter: jumpsdown}}
	\label{img:netsimile:dauer_13}
\end{figure}
