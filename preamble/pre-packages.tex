...
%\usepackage[toc]{appendix} % Um Anhang zu gestallten
...
\lstset{
	...
	keywordstyle =\color{blue}\bfseries\itshape, % \bfseries\color{blue}	  % Schlüsselwort-Style
...
\ohead[]{\thesection} % rechts: Section
